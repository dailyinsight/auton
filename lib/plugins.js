...
plugins.rules.js         = [plugins.read, plugins.jshint,     plugins.uglify, plugins.save] ;
plugins.rules.coffee     = [plugins.read, plugins.coffee,     plugins.uglify, plugins.save] ;
plugins.rules.handlebars = [plugins.read, plugins.handlebars, plugins.uglify, plugins.save] ;

plugins.rules.css        = [plugins.read,                     plugins.cssmin, plugins.save] ;
plugins.rules.stylus     = [plugins.read, plugins.stylus,     plugins.cssmin, plugins.save] ;
plugins.rules.less       = [plugins.read, plugins.less,       plugins.cssmin, plugins.save] ;
